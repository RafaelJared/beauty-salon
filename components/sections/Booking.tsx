...
import { Calendar, Clock, User, Phone, ChevronRight, CheckCircle2, MessageCircle } from "lucide-react";
  ...
  return (
    <section id="reservar" className="py-24 lg:py-32 bg-cream">
      <div className="section-padding max-w-2xl mx-auto">
        ...
        {/* Card */}
        <div className="bg-white rounded-4xl p-8 sm:p-10 shadow-card border border-nude/40">
          <AnimatePresence mode="wait">
            ...
            {step === 2 && !done && (
              ...
              >
                ...
                <div className="flex justify-between">
                  <button type="button" onClick={() => setStep(1)} className="btn-outline text-xs py-2.5 px-5">
                    Atrás
                  </button>
                  <button
                    type="button"
            ...
            {step === 3 && !done && (
              ...
              >
                ...
                <div className="flex justify-between">
                  <button type="button" onClick={() => setStep(2)} className="btn-outline text-xs py-2.5 px-5">
                    Atrás
                  </button>
                  <button
                    type="button"
            ...
            {step === 4 && !done && (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <button type="button" onClick={() => setStep(3)} className="btn-outline text-xs py-2.5 px-5">
                    Atrás
                  </button>
                  <button
                    type="button"
